...
# Notify that the lock script started
/usr/bin/notify-send "Lock" "Locking the screen..."

# Lock the screen with a solid color (black in this example)
# /usr/bin/swaylock -f -c 000000

# Lock the screen with black background and "Locked" text in white
swaylock -f \
    -c 000000 \
